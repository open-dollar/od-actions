...
// Token Kekkac256 Hashes
bytes32 constant RETH = bytes32(keccak256('RETH'));
bytes32 constant AAVE_RETH = bytes32(keccak256('AAVE_RETH'));
bytes32 constant WETH = bytes32(keccak256('WETH'));
bytes32 constant AAVE_WETH = bytes32(keccak256('AAVE_WETH'));
bytes32 constant WSTETH = bytes32(keccak256('WSTETH'));
bytes32 constant AAVE_WSTETH = bytes32(keccak256('AAVE_WSTETH'));
